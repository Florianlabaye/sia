...
octez-client gen keys my_account --force;
octez-client show address my_account;
octez-client get balance for my_account
"""

# The following code is to create new wallet on the Tezos blockchain. 

def creation_wallet(user):
    request_1 = """
    octez-client --endpoint https://ghostnet.tezos.marigold.dev config update;
    octez-client gen keys my_account --force;
    """
    ...
    request_2 = """
    octez-client show address my_account --show-secret
    """

    os.system(request_1)
    a = os.system(request_2)
